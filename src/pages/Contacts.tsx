    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <p className="text-muted-foreground mb-8 max-w-3xl">
          Мы всегда рады видеть вас в нашей кондитерской! Вы также можете связаться с нами 
          по телефону, электронной почте или через форму обратной связи.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">ул. Кондитерская, 15, Москва, 123456</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@sladko.ru</p>
                </div>
              </div>
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <Button type="submit" className="w-full sm:w-auto">Отправить сообщение</Button>
            </form>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="aspect-video w-full bg-muted rounded-lg overflow-hidden">
            {/* В реальном проекте здесь будет интеграция с Google Maps или Yandex Maps */}
            <div className="w-full h-full bg-muted flex items-center justify-center">
              <p className="text-muted-foreground">Здесь будет карта с местоположением нашей кондитерской</p>
            </div>
          </div>
        </div>
      </main>
